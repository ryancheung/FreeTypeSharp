...
namespace FreeTypeSharp.Native.LibraryLoader
{
    ...
    public abstract class LibraryLoader
    {
        ...
        public IntPtr LoadNativeLibrary(String name, PathResolver pathResolver)
        {
            ...
            if (ret == IntPtr.Zero)
                throw new FileNotFoundException($"COULD_NOT_LOAD_LIBRARY_FROM_NAME: {name}");
        ...
        public IntPtr LoadNativeLibrary(IEnumerable<String> names, PathResolver pathResolver)
        {
            ...
            if (ret == IntPtr.Zero)
                throw new FileNotFoundException($"COULD_NOT_LOAD_LIBRARY_FROM_NAMES: {String.Join(", ", names)}");
