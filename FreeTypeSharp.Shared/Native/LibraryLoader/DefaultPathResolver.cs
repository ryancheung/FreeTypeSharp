...
using PlatformSharp;
using Platform = PlatformSharp.Platform;

namespace FreeTypeSharp.Native.LibraryLoader
{
    /// <summary>
    ...
    public class DefaultPathResolver : PathResolver
    {
        ...
        private Boolean TryLocateNativeAssetInPlatformFolder(String name, out String platformResolvedPath)
        {
            ...
            if (PlatformInfo.CurrentPlatform == Platform.macOS && PlatformInfo.CurrentRuntime != Runtime.CoreCLR)
        ...
        private Boolean TryLocateNativeAssetFromDeps(String name, out String depsResolvedPath)
        {
            ...
            var userHomeDirectory = PlatformInfo.CurrentPlatform == Platform.Windows ?
